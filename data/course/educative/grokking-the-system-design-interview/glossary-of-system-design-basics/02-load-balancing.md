...
5. System administrators experience fewer failed or stressed components. Instead of a single device performing a lot of work, load balancing has several devices perform a little bit of work.`hello 20`

---
#### Load Balancing Algorithms
**How does the load balancer choose the backend server?**<br>
...
5. **Weighted Round Robin Method** <br>
...
2. https://lethain.com/introduction-to-architecting-systems-for-scale/
